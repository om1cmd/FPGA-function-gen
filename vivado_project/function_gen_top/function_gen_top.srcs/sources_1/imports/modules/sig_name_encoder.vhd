...
architecture behavioral of sig_name_encoder is
    ...
    signal left : std_logic_vector(27 downto 0);
    signal right : std_logic_vector(27 downto 0);
...
begin
    case cnt_sig is
        ...
        when b"11" =>
            left <= b"1111111_0100100_1001111_1101001"; -- -SIn
    ...
    case cnt_per is
        ...
        when b"11" =>
            right <= b"1001111_1111111_0110000_0100000"; -- 1-E6
