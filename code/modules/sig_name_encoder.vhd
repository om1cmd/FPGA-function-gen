...
entity sig_name_encoder is
    port (
        ...
        data : out std_logic_vector(31 downto 0)   --! Data for display_driver module
    );
...
begin
    case cnt is
        when x"0" =>
            data <= b"11111111_11111111_11111111_11111111";
        when x"1" =>
            data <= b"11111111_11111111_11111111_11111111";
        when x"2" =>
            data <= b"11111111_11111111_11111111_11111111";
        ...
        -- Default case
        when others =>
            data <= b"00000000_00000000_00000000_00000000";
    end case;
